...
public class DemoEdmProvider implements CsdlEdmProvider {
    ...
    @Override
    public CsdlAnnotations getAnnotationsGroup(FullQualifiedName fullQualifiedName) {
        return null;
    }

    @Override
    public CsdlAnnotatable getAnnotatable(FullQualifiedName fullQualifiedName) {
        return null;
    }
}
